        ...
        {view === 'landing' ? (
          <div className="w-full max-w-xl animate-in fade-in slide-in-from-left-8 duration-700">
            ...
            <p className="max-w-lg mb-10 text-lg font-light leading-relaxed text-muted-foreground">
              Project Sentinel provides decentralized, real-time monitoring with AI-driven early
              warning detection. Built for clinical teams to stay ahead of patient deterioration
              using highly responsive interactive interfaces.
            </p>
