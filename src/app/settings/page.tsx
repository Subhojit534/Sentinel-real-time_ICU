    ...
    <AppLayout>
      <div className="h-full overflow-y-auto scrollbar-thin">
        <div className="px-6 py-5 max-w-4xl mx-auto space-y-5">
          ...
          {/* Tab bar */}
          <div
            className="flex items-center gap-1 rounded-2xl p-1.5 border overflow-x-auto"
            style={{ backgroundColor: CARD, borderColor: BORDER }}
          >
            {TABS.map((tab) => {
              const Icon = tab.icon;
          ...
          {activeTab === 'profile' && (
            <div className="space-y-4">
              <Section
                ...
                desc="Update your name, contact details, and professional info"
              >
                {/* Avatar */}
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p
                      className="text-xs mt-0.5 capitalize px-2 py-0.5 rounded-md inline-block"
                      style={{
              ...
              <Section title="Alert Notifications" desc="Configure which alerts you receive">
                <div className="-my-2">
                  <NotifRow
                    ...
                    desc="Immediate notification for life-threatening events"
                    k="criticalAlerts"
                  />
                  <NotifRow
                    label="High Severity Alerts"
                    desc="Urgent clinical events requiring prompt action"
                    k="highAlerts"
                  />
                  <NotifRow
                    label="Moderate Alerts"
                    desc="Important but non-urgent clinical events"
                    k="moderateAlerts"
                  />
                  <NotifRow
                    label="Low Severity Alerts"
                    desc="Informational alerts for trend monitoring"
                    k="lowAlerts"
                  />
                  <NotifRow
                    label="AI Predictions"
                    desc="Proactive alerts from the AI deterioration model"
                    k="aiPredictions"
                  />
                </div>
              </Section>
              ...
              <Section title="System Notifications">
                <div className="-my-2">
                  <NotifRow
                    ...
                    desc="Notifications 30 minutes before shift start/end"
                    k="shiftReminders"
                  />
                  <NotifRow
                    label="System Updates"
                    desc="App updates, maintenance windows, and new features"
                    k="systemUpdates"
                  />
                </div>
              </Section>
              ...
              <Section title="Active Sessions" desc="Devices currently logged into your account">
                {[
                  ...
                  <div
                    ...
                    style={{ borderBottom: i === 0 ? `1px solid ${BORDER}` : 'none' }}
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className="w-2 h-2 rounded-full"
                        style={{ backgroundColor: s.active ? '#10B981' : MUTED }}
                      />
                      <div>
            ...
            <div className="space-y-4">
              <Section title="Interface Preferences">
                {[
                  ...
                  {
                    key: 'showAIRisk',
                    label: 'Show AI Risk Scores',
                    desc: 'Display AI deterioration probability on patient cards',
                  },
                  {
                    key: 'autoRefresh',
                    label: 'Auto-Refresh Data',
                    desc: 'Automatically refresh vitals and alerts',
                  },
                ].map(({ key, label, desc }) => (
                  <div
                    key={key}
                ...
                {display.autoRefresh && (
                  <div className="space-y-1.5">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setDisplay((d) => ({ ...d, refreshInterval: e.target.value }))
                      }
                      className="w-full text-sm rounded-xl px-3 py-2 outline-none"
                      style={{
                        backgroundColor: SURFACE,
          ...
          {activeTab === 'system' && (
            <div className="space-y-4">
              <Section
                ...
                desc="Read-only system details and integration status"
              >
                <div className="space-y-3">
                  {[
                    {
                      label: 'Application Version',
                      value: 'v2.4.1 (Build 2026.04.25)',
                      icon: Monitor,
                    },
                    {
                      label: 'Hospital',
                      value: 'City General Hospital · ID: hosp-1',
                      icon: Hospital,
                    },
                    {
                      label: 'Data Connection',
                      value: 'WebSocket connected · Latency 12ms',
                      icon: Wifi,
                      ok: true,
                    },
                    {
                      label: 'AI Model Version',
                      value: 'Sentinel-AI v3.2 · Updated 2026-04-20',
                      icon: Brain,
                    },
              ...
              <Section title="Support">
                {[
                  { label: 'Documentation', href: '#', desc: 'User guide and technical reference' },
                  {
                    label: 'Report a Bug',
                    href: '#',
                    desc: 'Submit an issue to the engineering team',
                  },
                  {
                    label: 'Request a Feature',
                    href: '#',
                    desc: 'Suggest improvements to the platform',
                  },
                  {
                    label: 'Contact ICT Support',
                    href: '#',
                    desc: 'Hospital IT helpdesk — ext. 4000',
                  },
                ].map(({ label, desc }) => (
                  <button
                    key={label}
                    className="w-full flex items-center justify-between py-3 hover:text-white transition-colors"
