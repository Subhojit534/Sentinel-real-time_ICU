...
const KPI_DATA = [
  ...
  },
  {
    ...
    label: 'Avg SpO₂',
    value: '94.2%',
    sub: '2 patients below threshold',
    icon: Droplets,
    trend: '-0.8% vs 2h ago',
    trendDir: 'down',
    trendBad: true,
      ...
      {KPI_DATA.map((kpi) => {
        ...
        return (
          <div
            ...
            style={{
              backgroundColor: `hsl(222,22%,11%) ${kpi.cardBg !== 'transparent' ? '' : ''}`,
